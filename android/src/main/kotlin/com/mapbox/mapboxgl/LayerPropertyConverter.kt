...
internal object LayerPropertyConverter {
    fun interpretSymbolLayerProperties(o: Any?): Array<PropertyValue<*>?> {
        ...
        val properties: MutableList<PropertyValue<*>?> = LinkedList<PropertyValue<*>?>()
        val parser = JsonParser()
        for ((key, value) in data) {
            val jsonElement = parser.parse(value)
            ...
            when (key) {
                ...
                "visibility" -> properties.add(PropertyFactory.visibility(value))
                else -> {}
            }
        }
